...
class TestEnrichmentCachePerformance:
    ...
    def test_cache_hit_performance(self, tmp_path: Path) -> None:
    ...
    def test_cache_miss_performance(self, tmp_path: Path) -> None:
    ...
    def test_concurrent_cache_access_performance(self, tmp_path: Path) -> None:
    ...
    def test_cache_ttl_performance(self, tmp_path: Path) -> None:
...
class TestEnrichmentTimeoutPerformance:
    ...
    def test_timeout_with_cache_fallback(self, tmp_path: Path) -> None:
    ...
    def test_bulk_timeout_handling(self, tmp_path: Path) -> None:
...
class TestConcurrentEnrichmentPerformance:
    ...
    def test_concurrent_ip_enrichment(self, tmp_path: Path) -> None:
    ...
    def test_concurrent_file_enrichment(self, tmp_path: Path) -> None:
...
class TestMockHandlerPerformance:
    ...
    def test_mock_otx_performance(self, tmp_path: Path) -> None:
    ...
    def test_mock_abuseipdb_performance(self, tmp_path: Path) -> None:
...
class TestMemoryUsagePerformance:
    ...
    def test_memory_usage_during_bulk_enrichment(self, tmp_path: Path) -> None:
    ...
    def test_cache_memory_efficiency(self, tmp_path: Path) -> None:
    ...
    def test_concurrent_memory_usage(self, tmp_path: Path) -> None:
...
class TestEnrichmentThroughput:
    ...
    def test_sequential_throughput(self, tmp_path: Path) -> None:
    ...
    def test_cached_throughput(self, tmp_path: Path) -> None:
    ...
    @pytest.mark.asyncio
    async def test_async_enrichment_throughput(self, tmp_path: Path) -> None:
