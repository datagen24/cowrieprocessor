...
class TestCowrieSchemaValidation:
    ...
    def test_cowrie_schema_validates_login_event_succeeds(self, valid_login_event: dict[str, Any]) -> None:
    ...
    def test_cowrie_schema_validates_command_event_succeeds(self, valid_command_event: dict[str, Any]) -> None:
    ...
    def test_cowrie_schema_rejects_malformed_event(self, malformed_event: dict[str, Any]) -> None:
    ...
    def test_cowrie_schema_handles_unknown_event_type(self, unknown_event_type: dict[str, Any]) -> None:
    ...
    def test_cowrie_schema_extracts_event_type_from_valid_event(self, valid_login_event: dict[str, Any]) -> None:
    ...
    def test_cowrie_schema_extracts_event_type_from_malformed_event(self, malformed_event: dict[str, Any]) -> None:
    ...
    def test_cowrie_schema_repairs_event_fields(self, malformed_event: dict[str, Any]) -> None:
