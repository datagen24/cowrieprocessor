...
def test_cowrie_database_get_schema_version_returns_version(cowrie_db: CowrieDatabase, db_session_with_data: Session) -> None:
...
def test_cowrie_database_validate_schema_works_with_real_db(cowrie_db: CowrieDatabase, db_session_with_data: Session) -> None:
...
def test_cowrie_database_main_function_handles_help_command(
    tmp_path: Path
) -> None:
...
def test_cowrie_database_main_function_handles_migrate_command(
    tmp_path: Path
) -> None:
...
def test_cowrie_database_main_function_handles_check_command(
    tmp_path: Path
) -> None:
...
def test_cowrie_database_main_function_handles_files_command(
    tmp_path: Path
) -> None:
...
def test_cowrie_database_main_function_handles_analyze_command(
    tmp_path: Path
) -> None:
...
def test_cowrie_database_main_function_handles_invalid_command(
    tmp_path: Path
) -> None:
